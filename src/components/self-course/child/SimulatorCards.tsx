...
import { Lightbulb, Bot, Palette, Coins, Mic, MessageSquare, Rocket } from "lucide-react";
...
const simulators = [
  {
    id: "entre-skills-sim" as SimulatorType,
    title: "Entre Skills Simulator (New)",
    description: "Interactive voice & chat-based learning!",
    icon: Rocket,
...
const SimulatorCards = ({ onSelectSimulator }: SimulatorCardsProps) => {
  ...
  const handleSimulatorClick = (simulatorId: SimulatorType) => {
    if (simulatorId === "entre-skills-sim") {
